module.exports = function(crowi, app) {
  ...
  app.get('/installer/ldap'             , middleware.applicationNotInstalled() , installer.ldap);
  app.post('/installer/ldap'            , middleware.applicationNotInstalled() , form.admin.ldapSetting, installer.setupLdap);
  app.post('/installer/ldap/createAdmin', middleware.applicationNotInstalled() , form.registerLdap     , installer.createAdminFromLdap);
  ...
  //app.post('/_api/admin/settings/ldap'  , loginRequired(crowi, app) , middleware.adminRequired() , form.admin.ldap, admin.api.appSetting);
